...
//   - /content/$slug list (filters, search, sort, pagination, auth gates)
//   - /content/$slug/new editor (toolbar, auto-slug, submit)
//   - /content/$slug/$id editor (load existing, edit, meta-box sidebar)
