...
- [#2329](https://github.com/withplumix/plumix/pull/2329) [`d60272f`](https://github.com/withplumix/plumix/commit/d60272f4ef2541ae9e09f0ea1adb44d7409631ec) Thanks [@nasyrov](https://github.com/nasyrov)! - Fixes the admin manifest normalizer silently dropping `dashboardWidgets` and
