// The island-fault event contract: `@plumix/blocks` owns "what an island fault
// looks like" and fires `plumix:island-*` events; core's dev tools consume this
// to read them (core → blocks, the allowed direction). Both consumers of the
