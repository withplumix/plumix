...
- [#2445](https://github.com/withplumix/plumix/pull/2445) [`3515b77`](https://github.com/withplumix/plumix/commit/3515b77682517e3b1560143008b42e0fc18f24fd) Thanks [@nasyrov](https://github.com/nasyrov)! - Contributes its debug panel through core's renamed `debug:panels` filter, and declares the `og` panel id so `dev: { panels: { og: false } }` type-checks.
