...
// The meta-box field vocabulary now lives beside the fluent builders that
// compile to it; re-export it here so the public `@plumix/core/manifest`
// surface is unchanged.
export * from "./fields/meta-box-field.js";

// The runtime registry container now lives in its own module; re-export it
// here so the public `@plumix/core/manifest` surface is unchanged.
