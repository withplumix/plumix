// Generates apps/demo/seed.sql — the content seeded into the demo sandbox.
//
...
//   wrangler d1 execute plumix_demo --local  --file=seed.sql
//   wrangler d1 execute plumix_demo --remote --file=seed.sql   # live demo
//
...
emit("-- Apply with: wrangler d1 execute plumix_demo --local --file=seed.sql");
emit("");
