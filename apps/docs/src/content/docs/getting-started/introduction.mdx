...
Core carries the parts every site needs: entries, taxonomies, meta-box fields, blocks and marks, the block editor, the template hierarchy, sessions and roles, the REST and RPC layers, redirects, sitemaps, the edge cache, and scheduled tasks.
