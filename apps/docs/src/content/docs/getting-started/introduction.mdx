---
title: Introduction
description: Plumix is a CMS you declare in TypeScript. It deploys as one process — a Node.js server by default, or a Cloudflare Worker — that renders the public site from a theme you own and builds its admin screens from your content model.
tier: P0
sidebar:
  order: 10
---
