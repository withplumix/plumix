...
1. **Declare the rule, the slot and the builders.** The rule is `TierMatchRule` plus an `href`. `selector` is the bind function. The builders wrap the target constructors so the chain ends in `.advertise(...)`.
   ...
   import type { EntryTypeTargets, TierMatchRule } from "plumix/plugin";
   import { entryTypeTargets } from "plumix/plugin";
...
2. **Snapshot what the theme declared, then resolve against it.** The theme is validated after plugins install, so its rules arrive on the `theme:ready` handover rather than in `setup`. One snapshot serves every request.
   ...
   ```ts
   import type { TemplateData, ThemeDescriptor } from "plumix";
   import type { ResolvedNode } from "plumix/plugin";
   import { definePlugin, resolveErrorRule, resolveRule } from "plumix/plugin";
...
```ts
import type { TierMatchRule } from "plumix/plugin";
import { entryTypeTargets } from "plumix/plugin";
...
```ts
import type { TierMatchRule } from "plumix/plugin";
import { termTaxonomyTargets } from "plumix/plugin";
...
```ts
import type { TierMatchRule } from "plumix/plugin";
import { authorTargets } from "plumix/plugin";
...
```ts
import type { TierMatchRule } from "plumix/plugin";
import { dateTargets } from "plumix/plugin";
...
```ts
import type { TierMatchRule } from "plumix/plugin";
import { archiveTypeTargets } from "plumix/plugin";
...
```ts
import type { EntryTypeName } from "plumix";
import type { EntryTypeTargets, TierMatchRule } from "plumix/plugin";
import { entryTypeMatch, entryTypeTargets, metaEquals } from "plumix/plugin";
...
```ts
import type { TierMatchRule } from "plumix/plugin";
import { entryTypeMatch } from "plumix/plugin";
...
```ts
import type { TierMatchRule } from "plumix/plugin";
import { termTaxonomyMatch } from "plumix/plugin";
...
```ts
import { entryTypeMatch, metaEquals } from "plumix/plugin";
...
```ts
import { metaEquals, termMetaEquals, termTaxonomyMatch } from "plumix/plugin";
